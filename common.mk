...
XDR_DEFINES =
if XDR_HELLO_WORLD
AM_CPPFLAGS += -DXDR_HELLO_WORLD
XDR_DEFINES += -DXDR_HELLO_WORLD
endif # XDR_HELLO_WORLD

if XDR_TRANSACTION_META_V5
AM_CPPFLAGS += -DXDR_TRANSACTION_META_V5
XDR_DEFINES += -DXDR_TRANSACTION_META_V5
endif # XDR_TRANSACTION_META_V5

if XDR_LEDGER_ENTRY_EXT_V2
AM_CPPFLAGS += -DXDR_LEDGER_ENTRY_EXT_V2
XDR_DEFINES += -DXDR_LEDGER_ENTRY_EXT_V2
endif # XDR_LEDGER_ENTRY_EXT_V2

if XDR_SPARSE_MAP
AM_CPPFLAGS += -DXDR_SPARSE_MAP
XDR_DEFINES += -DXDR_SPARSE_MAP
endif # XDR_SPARSE_MAP
