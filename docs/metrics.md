...
bucketlistDB-<X>.point-time.<Y>           | counter   | sum of time (microseconds) to load single entry of type <Y> on BucketList <X> (live/hotArchive)
bucketlistDB-<X>.point-count.<Y>          | counter   | number of times single entry of type <Y> on BucketList <X> (live/hotArchive) is loaded
...
herder.pending[-soroban]-txs.delay-time   | counter     | sum of time (microseconds) for transactions to be included in a ledger
herder.pending[-soroban]-txs.delay-count  | counter     | number of transactions to be included in a ledger
herder.pending[-soroban]-txs.self-delay-time          | counter     | sum of time (microseconds) for transactions submitted from this node to be included in a ledger
herder.pending[-soroban]-txs.self-delay-count         | counter     | number of transactions submitted from this node to be included in a ledger
...
overlay.flood.advert-delay-time           | counter   | sum of time (microseconds) each advert sits in the inbound queue
overlay.flood.advert-delay-count          | counter   | number of times advert delay is measured
...
overlay.recv.transaction-time             | counter   | sum of time (microseconds) to receive transaction message
