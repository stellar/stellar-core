...
soroban.host-fn-op.ledger-cpu-insns-ratio    | histogram | ratio between ledger time (nanoseconds) and metered CPU instructions
soroban.host-fn-op.ledger-cpu-insns-ratio-excl-vm | histogram | ratio between ledger time (nanoseconds) and metered CPU instructions, excluding VM instantiation
