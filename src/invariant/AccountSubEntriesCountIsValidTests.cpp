                        ...
                        UpdateList const& updatesBase)
{
    if (deltaNumSubEntries != 0)
    {
        ...
        updates.push_back(std::make_tuple(&leCurr, &lePrev));
                           ...
                           std::vector<LedgerEntry>& subentries)
{
    ...
    else
    {
        ...
        updateAccountSubEntries(app, le, lePrev, 1, makeUpdateList(&se, nullptr));
    }
}
                                ...
                                std::default_random_engine& gen)
{
    ...
    else
    {
        ...
        updateAccountSubEntries(app, le, lePrev, 0, makeUpdateList(&se2, &se));
    }
}
                                ...
                                std::default_random_engine& gen)
{
    ...
    else
    {
        ...
        updateAccountSubEntries(app, le, lePrev, -1, makeUpdateList(nullptr, &se));
    }
}
          ...
          "[invariant][accountsubentriescount]")
{
    ...
    for (uint32_t i = 0; i < 50; ++i)
    {
        ...
        }
        {
            ...
            {
                apply.push_back(std::make_tuple(nullptr, &se));
            }
