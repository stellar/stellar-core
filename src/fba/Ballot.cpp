...
namespace stellar
{
    namespace ballot
    {
        ...
        {
            if(b1.closeTime != b2.closeTime) return false;
            if(b1.baseFee != b2.baseFee) return false;
            if(b1.txSetHash != b2.txSetHash) return false;
        ...
        {
            if(b1.txSetHash != b2.txSetHash) return(b1.txSetHash > b2.txSetHash);
            if(b1.closeTime != b2.closeTime) return(b1.closeTime > b2.closeTime);
            if(b1.baseFee > b2.baseFee) return true;
        ...
        {
            if(b1.index > b2.index) return true;
