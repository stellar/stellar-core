          ...
          "[herder][parallel][jitter]")
{
    ...
    std::vector<JitterInjector::Config> jitterConfigs = {
        {1.0, 100'000, 10'000'000},       // 100% prob, 100µs-10ms
        {0.5, 1'000'000, 10'000'000},     // 50% prob, 1ms-10ms
        {0.2, 1'000'000, 50'000'000},     // 20% prob, 1ms-50ms
        {0.1, 50'000'000, 100'000'000},   // 10% prob, 5ms-100ms
        {0.01, 100'000'000, 500'000'000}, // 1% prob, 100ms-500ms
    };
    ...
    for (uint32_t iteration = 0; iteration < NUM_ITERATIONS; ++iteration)
    {
        SECTION("iteration " + std::to_string(iteration))
        {
            ...
            REQUIRE(iteration < NUM_ITERATIONS);
            ...
            CLOG_INFO(Test,
                      ...
                      "applied (probability={:.0f}%, delay range: {}-{}ms)",
                      iteration, injectionCount, delayCount,
                      jitterConfigs[iteration].defaultProbability * 100.0,
