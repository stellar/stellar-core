...
//             TxFrameList invalidTxs;
//             auto txSet =
//                 makeTxSetFromTransactions({fb1, fb2}, *app, 0, 0,
//                 invalidTxs);
...
//             auto tx2 = transaction(*app, account1, 2, -1, 100);
//             auto fb2 =
//                 feeBump(*app, account2, tx2, minBalance2 - minBalance0 -
//                 199);
//             TxFrameList invalidTxs;
//             auto txSet =
//                 makeTxSetFromTransactions({fb1, fb2}, *app, 0, 0,
...
//             TxFrameList removed;
//             auto txSet = makeTxSetFromTransactions({tx1, txInvalid}, *app, 0,
//             0,
//                                                    removed);
//             REQUIRE(removed.back() == txInvalid);
...
//             removed.clear();
//             txSet = makeTxSetFromTransactions({tx1, tx2}, *app, 0, 0,
...
//             TxFrameList removed;
//             auto txSet =
//                 makeTxSetFromTransactions({txDupeSigner}, *app, 0, 0,
//                 removed);
...
//         false); newC->start(); HerderImpl& newHerderC =
...
// // Generate a tier1-like topology. This topology has 7 HIGH quality orgs, 6
// of
