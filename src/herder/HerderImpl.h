...
class HerderImpl : public Herder
{
  public:
    ...
    std::shared_ptr<MutableTransactionResultBase const> checkValidCached(
  ...
  private:
    ...
    mutable RandomEvictionCache<
        TxValidityKey, std::shared_ptr<MutableTransactionResultBase const>,
        TxValidityKeyHash>
        mTxValidCache;
};
}
