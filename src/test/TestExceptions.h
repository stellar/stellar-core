...
TEST_EXCEPTION(ex_BUMP_SEQ_NOT_SUPPORTED_YET)
TEST_EXCEPTION(ex_BUMP_SEQ_NO_ACCOUNT)
TEST_EXCEPTION(ex_BUMP_SEQ_INVALID_RANGE)
TEST_EXCEPTION(ex_BUMP_SEQ_OUT_OF_RANGE)
TEST_EXCEPTION(ex_BUMP_SEQ_NO_SELF_BUMP)
