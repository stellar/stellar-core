...
TEST_EXCEPTION(ex_txFROZEN_KEY_ACCESSED)
...
TEST_EXCEPTION(ex_CLAIM_CLAIMABLE_BALANCE_TRUSTLINE_FROZEN)

TEST_EXCEPTION(ex_REVOKE_SPONSORSHIP_DOES_NOT_EXIST)
TEST_EXCEPTION(ex_REVOKE_SPONSORSHIP_NOT_SPONSOR)
TEST_EXCEPTION(ex_REVOKE_SPONSORSHIP_LOW_RESERVE)
TEST_EXCEPTION(ex_REVOKE_SPONSORSHIP_ONLY_TRANSFERABLE)
TEST_EXCEPTION(ex_REVOKE_SPONSORSHIP_MALFORMED)
...
TEST_EXCEPTION(ex_LIQUIDITY_POOL_DEPOSIT_TRUSTLINE_FROZEN)
...
TEST_EXCEPTION(ex_LIQUIDITY_POOL_WITHDRAW_TRUSTLINE_FROZEN)

TEST_EXCEPTION(ex_INVOKE_HOST_FUNCTION_MALFORMED)
TEST_EXCEPTION(ex_INVOKE_HOST_FUNCTION_TRAPPED)
TEST_EXCEPTION(ex_INVOKE_HOST_FUNCTION_RESOURCE_LIMIT_EXCEEDED)

TEST_EXCEPTION(ex_EXTEND_FOOTPRINT_TTL_MALFORMED)
TEST_EXCEPTION(ex_EXTEND_FOOTPRINT_TTL_RESOURCE_LIMIT_EXCEEDED)

TEST_EXCEPTION(ex_RESTORE_FOOTPRINT_MALFORMED)
TEST_EXCEPTION(ex_RESTORE_FOOTPRINT_RESOURCE_LIMIT_EXCEEDED)
}
}
