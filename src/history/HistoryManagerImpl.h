...
class HistoryManagerImpl : public HistoryManager
{
  ...
  public:
    ...
    bool maybeQueueHistoryCheckpoint(
        CompleteConstLedgerStatePtr ledgerState) override;

    void queueCurrentHistory(CompleteConstLedgerStatePtr ledgerState) override;
