...
BucketApplicator::Counters::getRates(
    ...
    uint64_t& lu_sec, uint64_t& ld_sec, uint64_t& sc_sec, uint64_t& T_sec,
    uint64_t& total)
{
    ...
    sc_sec = (mSpeedexConfigurationUpsert * 1000000) / usecs;
                                    ...
                                    VirtualClock::time_point now)
{
    uint64_t au_sec, ad_sec, tu_sec, td_sec, ou_sec, od_sec, du_sec, dd_sec,
        cu_sec, cd_sec, lu_sec, ld_sec, sc_sec, T_sec, total;
    getRates(now, au_sec, ad_sec, tu_sec, td_sec, ou_sec, od_sec, du_sec,
             dd_sec, cu_sec, cd_sec, lu_sec, ld_sec, sc_sec, T_sec, total);
    CLOG_INFO(Bucket,
              "Apply-rates for {}-entry bucket {}.{} au:{} ad:{} tu:{} td:{} "
              "ou:{} od:{} du:{} dd:{} cu:{} cd:{} lu:{} ld:{} sc:{} T:{}",
              total, level, bucketName, au_sec, ad_sec, tu_sec, td_sec, ou_sec,
              od_sec, du_sec, dd_sec, cu_sec, cd_sec, lu_sec, ld_sec, sc_sec,
              T_sec);
    CLOG_INFO(Bucket,
              "Entry-counts for {}-entry bucket {}.{} au:{} ad:{} tu:{} td:{} "
              "ou:{} od:{} du:{} dd:{} cu:{} cd:{} lu:{} ld:{} sc:{}",
              ...
              mLiquidityPoolDelete, mSpeedexConfigurationUpsert);
}
