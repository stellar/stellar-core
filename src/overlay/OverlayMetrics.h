...
struct OverlayMetrics
{
    ...
    medida::Counter& mTxPullLatencyAccumulator;
    medida::Counter& mTxPullLatencyCounter;
    medida::Counter& mPeerTxPullLatencyAccumulator;
    medida::Counter& mPeerTxPullLatencyCounter;
