...
namespace stellar
{
	...
	public:
        ...
        virtual void fetchDelta(stellarxdr::uint256 const& oldLedgerHash, uint32_t oldLedgerSeq) = 0;

		// called by TxHerder
		virtual void broadcastMessage(stellarxdr::uint256 const& messageID) = 0;

		//called by FBA
		virtual QuorumSet::pointer fetchQuorumSet(stellarxdr::uint256 const& itemID, bool askNetwork)=0;

		// called internally and by FBA
		virtual void broadcastMessage(stellarxdr::StellarMessage const& msg, Peer::pointer peer)=0;
        ...
        virtual void doesntHaveQSet(stellarxdr::uint256 const& index, Peer::pointer peer) = 0;
        virtual void recvFloodedMsg(stellarxdr::uint256 const& index, stellarxdr::StellarMessage const& msg, uint32_t ledgerIndex, Peer::pointer peer) = 0;
