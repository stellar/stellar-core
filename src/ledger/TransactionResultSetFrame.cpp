...
TransactionResultSetFrame::TransactionResultSetFrame(uint32_t protocolVersion)
{
    ...
    // TODO: for the time being, we are _not_ hashing or emitting
    // TransactionResutlSetFrameV2 structures because we have not worked out how
    // to transition horizon, the history archives / catchup code, archivist,
