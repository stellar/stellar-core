    ...
    return runWithHelp(
        ...
        [&] {
            ...
            auto& app = *appPtr;
            {
                ...
                // In the limit-based mode, we may publish the history
                // checkpoint just before performing the benchmark. This way
                // the checkpoint could be used for both setting up the
                // throughput benchmark downstream, and also potentially for
                // speeding up the subsequent benchmark runs via catchup (that's
                    ...
                    app.getHistoryArchiveManager().publishEnabled())
                {
                    ...
                    do
                    {
                        ...
                        !app.getHistoryManager().maybeQueueHistoryCheckpoint(
