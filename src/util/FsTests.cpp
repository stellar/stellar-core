...
{
    using DataValue = std::tuple<std::string, std::string, std::vector<std::string>>;
    auto data = std::vector<DataValue>{
        DataValue{"root", "/", {"/"}},
        DataValue{"simple dir", "simple", {"simple"}},
        DataValue{"nested dir", "nested1/nested2/", {"nested1", "nested1/nested2"}},
        DataValue{"nested dir with multiple slashes", "nested1///nested2/", {"nested1", "nested1/nested2"}},
        DataValue{"nested dir starting at root", "/nested1/nested2/", {"/", "/nested1", "/nested1/nested2"}},
        DataValue{"nested dir starting at rootwith multiple slashes", "/nested1///nested2/", {"/", "/nested1", "/nested1/nested2"}}
    };
