...
TEST_CASE("bump sequence", "[tx][bumpsequence]")
{
    ...
    SECTION("tests without a range")
    {
        ...
        SECTION("test no-account")
        {
            ...
            auto p1 = s1.getPublicKey();
            for_all_versions(app, [&]{
                    REQUIRE_THROWS_AS(a1.bumpSequence(p1, num+110, nullptr),
                            ex_BUMP_SEQ_NO_ACCOUNT);
                });
        ...
        {
            for_all_versions(app, [&]{
                    REQUIRE_THROWS_AS(a1.bumpSequence(a1.getPublicKey(), num+110, nullptr),
        ...
        SECTION("test success")
        {
            for_all_versions(app, [&]{
                    ...
                    REQUIRE_NOTHROW(a1.bumpSequence(a2.getPublicKey(), num+100, nullptr));
    ...
    SECTION("tests with a range")
    {
        ...
        SECTION("test invalid-range")
        {
            ...
            for_all_versions(app, [&]{
                    auto num = a2.loadSequenceNumber();
                    REQUIRE_THROWS_AS(a1.bumpSequence(a2.getPublicKey(), 110, &invalid_range),
        ...
        SECTION("test out-of-range")
        {
            SECTION("below range")
            {
                for_all_versions(app, [&]{
                        ...
                        REQUIRE_THROWS_AS(a1.bumpSequence(a2.getPublicKey(), num+300, &below_range),
            ...
            SECTION("above range")
            {
                for_all_versions(app, [&]{
                        ...
                        REQUIRE_THROWS_AS(a1.bumpSequence(a2.getPublicKey(), num+300, &above_range),
                                ex_BUMP_SEQ_OUT_OF_RANGE);
                        REQUIRE(num == a2.loadSequenceNumber());
                    });
            }
            SECTION("in range")
            {
                for_all_versions(app, [&]{
                        ...
                        REQUIRE_NOTHROW(a1.bumpSequence(a2.getPublicKey(), num + 100, &in_range));
                        REQUIRE(num+100 == a2.loadSequenceNumber());
                    });
            }
        }
        SECTION("test locked-range")
        {
            ...
            for_all_versions(app, [&]{
                    REQUIRE_NOTHROW(a1.bumpSequence(a2.getPublicKey(), num+100, &exact_range));
                    REQUIRE(num+100 == a2.loadSequenceNumber());
                });
        }
    }
