    ...
    OperationMetaBuilder& opMeta) const
{
    ...
    auto& diagnosticEvents = opMeta.getDiagnosticEventBuffer();
    ...
    opMeta.getEventManager().setEvents(std::move(success.events));
    opMeta.setSorobanReturnValue(success.returnValue);
