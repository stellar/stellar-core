...
//
//static void
//submitTxToDeployContract(Application& app, Operation const& uploadOp,
...
//    auto& uploadHF = uploadOp.body.invokeHostFunctionOp();
//    uploadHF.functions.type(HOST_FUNCTION_TYPE_UPLOAD_CONTRACT_WASM);
//    auto& uploadContractWasmArgs = uploadHF.function.uploadContractCodeArgs();
//    uploadContractWasmArgs.code.assign(contractWasm.data.begin(),
//                                    contractWasm.data.end());
//
//    LedgerKey contractCodeLedgerKey;
//    contractCodeLedgerKey.type(CONTRACT_CODE);
//    contractCodeLedgerKey.contractCode().hash = xdrSha256(uploadContractWasmArgs);
//
...
//        app, uploadOp, createOp, contractCodeLedgerKey.contractCode().hash,
