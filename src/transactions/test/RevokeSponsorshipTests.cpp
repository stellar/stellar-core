...
TEST_CASE_VERSIONS("update sponsorship", "[tx][sponsorship]")
{
            ...
            SECTION("account is not sponsored")
            {
                SECTION("account")
                {
                    ...
                    auto tx = transactionFrameFromOps(
                        *app, a1, {a1.op(revokeSponsorship(accountKey(a1)))},
                        {});
                ...
                SECTION("signer")
                {
                    ...
                    auto tx = transactionFrameFromOps(
                        *app, a1, {a1.op(revokeSponsorship(a1, signer.key))},
                        {});
        ...
        SECTION("failure tests")
        {
            ...
            SECTION("not sponsor")
            {
                ...
                auto notSponsorTest = [&](bool isSponsored, bool entryTest) {
                    ...
                    auto tx = transactionFrameFromOps(*app, a2, {op}, {});
                    ...
                    if (isSponsored)
                    {
                        ...
                        auto tx3 = transactionFrameFromOps(*app, a2, {op}, {});
            ...
            SECTION("low reserve")
            {
                ...
                auto lowReserveTest = [&](bool entryTest) {
                    ...
                    SECTION("remove sponsorship")
                    {
                        ...
                        auto tx2 =
                            transactionFrameFromOps(*app, root, {opTx2}, {});
    ...
    SECTION("invalid input")
    {
        ...
        auto revoke = [&](LedgerKey const& ledgerKey) {
            auto tx = transactionFrameFromOps(
                *app, a1, {a1.op(revokeSponsorship(ledgerKey))}, {});
