#include "transactions/SetOptionsTx.h"

// TODO.2 Handle all SQL exceptions
namespace stellar
{
    void SetOptionsTx::doApply(TxDelta& delta, LedgerMaster& ledgerMaster)
    {
        ...
        {
            mSigningAccount->mEntry.account().pubKey = *mEnvelope.tx.body.setOptionsTx().pubKey;
        }
