...
4. **Question your assumptions and seek absolute clarity**: Ask yourself
...
- Are new/modified interfaces used correctly everywhere?
...
- Will the program recover safely from a crash, or can data be corrupted or lost?
- What forms of partial failure are possible, and are they handled safely?
- Are state changes made atomically and consistently?
